...
const DEFAULT_GLOW_COLOR = '239, 68, 68'; // Red to match theme
    ...
    return (
        <>
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(239, 68, 68, 0.1), 0 0 30px rgba(${glowColor}, 0.1);
          }
                    ...
                    {cards.map((card, index) => {
                        ...
                        const content = (
                            <>
                                ...
                                <div className="card__header flex flex-col gap-3 relative z-10">
                                    <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary">
                                        {card.icon}
                                    </div>
                                    <span className="card__label text-xs font-bold uppercase tracking-wider text-primary/80">{card.label}</span>
                                </div>
