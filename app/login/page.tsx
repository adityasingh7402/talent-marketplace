...
import { Star, Mail, Lock, ChevronRight, ChevronLeft, Loader2 } from "lucide-react";
...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Success! Redirect based on role or approval status
            // We will handle the "pending" check in the dashboard or middleware
            router.push("/dashboard");
        } catch (err: any) {
            // Error already handled by toast in most cases, but good for catch-all
            ...
            >
                <div className="flex flex-col items-center mb-10 text-center">
                    <h1 className="font-heading text-4xl md:text-5xl font-black tracking-tighter text-white mb-2">
                        Welcome <span className="text-primary italic"><GlitchText speed={0.5}>Back.</GlitchText></span>
                    </h1>
                ...
                <div className="glass p-8 rounded-[2.5rem] border border-white/10 shadow-3xl">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between mb-1">
                                ...
                                <Link href="/forgot-password" title="Forgot Password?" className="text-[10px] font-bold uppercase tracking-widest text-primary hover:opacity-80 transition-opacity">
                                    Forgot Password?
                                </Link>
                            </div>
                            <div className="relative">
                    ...
                    <div className="mt-8 pt-8 border-t border-white/10 text-center">
                        <p className="text-white/40 font-medium text-sm">
                            ...
                            <Link href="/signup" className="text-primary hover:underline font-bold transition-all ml-1">
                                Create One
                            </Link>
                        </p>
                    </div>
